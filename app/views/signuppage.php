            ...
            <div id="signupbox" style="margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        ...
                        <div style="float:right; font-size: 85%; position: relative; top:-10px">Already have an account ?<a id="signinlink" href="login">Login</a></div>
                    </div>  
                    <div class="panel-body" >
                        <form id="signupform" class="form-horizontal" role="form" action="signup" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="number" placeholder="" id="number">
                                </div>
                            </div>
