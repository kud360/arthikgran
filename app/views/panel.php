        ...
        <div class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">                    
                    <a class="navbar-brand navbar-left" href="https://bajajcapital.com">
                    ...
                    <div class="navbar-text navbar-right">Signed in as <?= Auth::user()->firstname.' '.Auth::user()->lastname ?>. <a href="logout" class="link">Logout</a></div>
                </div>                
            </div>
        </div>
        <div class="container">
            <h1>
                OMR Answer Sheet Interpretation System (O.A.S.I.S.)
            </h1>
            <h2 class="lead">Version 1.0</h2>

            <div class="row">
                <!-- The fileinput-button span is used to style the file input field as button -->
                <div class="btn btn-success fileinput-button col-lg-2 col-md-2  col-sm-12 col-xs-12">
                    <i class="glyphicon glyphicon-plus"></i>
                    <span>Select files...</span>
                    <!-- The file input field used as target for the file upload widget -->
                    <input id="fileupload" type="file" name="files[]" multiple>
                </div>
                <div class="well well-sm col-lg-9 col-lg-offset-1  col-md-9 col-md-offset-1 col-sm-12 col-xs-12">
                    <b>
                        Status:
                    </b>
                    <span id="statusText">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="answers">
                    <blockquote>
                        ...
                        <p>
                            Click on one of the Set Number. of which you want to change the correct answer sequence. Once the list of answers are open, click on the option A, B, C or D whichever indicated the correct answer.
                        </p>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                                            <strong> Set 1 </strong> <small style="display: inline-block;">Click here to expand</small>
                                        </a>
                                    </h4>
                                </div>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                            <strong> Set 2 </strong> <small style="display: inline-block;">Click here to expand</small>
                                        </a>
                                    </h4>
                                </div>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                                            <strong> Set 3 </strong><small style="display: inline-block;">Click here to expand</small>
                                        </a>
                                    </h4>
                                </div>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">
                                            <strong> Set 4 </strong> <small style="display: inline-block;">Click here to expand</small>
                                        </a>
                                    </h4>
                                </div>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">
                                            <strong> Set 5 </strong> <small style="display: inline-block;">Click here to expand</small>
                                        </a>
                                    </h4>
                                </div>
